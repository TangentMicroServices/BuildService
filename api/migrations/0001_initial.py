# -*- coding: utf-8 -*-
# Generated by Django 1.9.2 on 2016-05-22 15:34
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('smell', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='api.Smell')),
            ],
        ),
        migrations.AddField(
            model_name='metric',
            name='build',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='api.Repo'),
        ),
        migrations.AddField(
            model_name='build',
            name='repo',
